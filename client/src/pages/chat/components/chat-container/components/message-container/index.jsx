    ...
    return (
      ...
      >
        {message.messageType === MESSAGE_TYPES.TEXT && (
          <div
            className={`${message.sender !== selectedChatData._id
              ? "bg-[#28a745]/5 text-white/80 border-green-500/50 rounded-full"
              : "bg-[#79b8ff]/5 text-white/80 border-blue-700/20 rounded-full"
        ...
        {message.messageType === MESSAGE_TYPES.FILE && (
          <div
            className={`${message.sender !== selectedChatData._id
              ? "bg-[#28a745]/5 text-green/90 border-[#28a745]/50"
              : "bg-[#79b8ff]/10 text-white/80 border-bluee-500/20"
