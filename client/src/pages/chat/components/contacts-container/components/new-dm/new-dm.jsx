    ...
    <>
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <TiUserAdd
              className=" text-neutral-400 font-light text-opacity-90 text-xl hover:text-neutral-100 cursor-pointer transition-all duration-300"
              onClick={() => setOpenNewContactModal(true)}

            />
          </TooltipTrigger>
          <TooltipContent className="bg-[#1c1b1e] border-none mb-2 p-3 text-green-500">
            Pull New Convo
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
        ...
        <DialogContent className='bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col'>
          <DialogHeader>
            <DialogTitle>Select the Collaborator</DialogTitle>

          </DialogHeader>
          <div>
            <Input
              placeholder="Search Collaborator"
              className='rounded-full p-6 bg-[#2c2e3b] border-none'
                ...
                <div className="flex-1  md:flex mt-5  flex-col justify-center items-center hidden duration-1000 transition-all">
                  ...
                  <div className="text-opacity-80 text-white  flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-1000 text-center">
                    <h3 className='roboto-medium'>
                      <span className='text-blue-500'>Lets!</span> Find new <span className='text-green-600'>Collaborator</span>
                    </h3>
                  </div>
                </div>
              )}
